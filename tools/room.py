...
def write_room(tilemap, output_file):
    ...
    output_file.write("  .addr " + tilemap.bg_palette + " ; BG palette table (ptr) for this room\n")
    output_file.write("  .byte <.bank(" + tilemap.bg_palette + ") ; BG palette table (bank) for this room\n")
