...
flail_north:
        ;         X,  Y, TileId, Behavior
        .lobytes -2, -1, SPRITE_TILE_FLAIL_HEAD, NONE, (WEAPON_SINGLE_TARGET)
        .lobytes  2, -1, SPRITE_TILE_FLAIL_HEAD, NONE, (WEAPON_SINGLE_TARGET)
        .lobytes -1, -1, SPRITE_TILE_FLAIL_HEAD, NONE, (WEAPON_SINGLE_TARGET)
        .lobytes  1, -1, SPRITE_TILE_FLAIL_HEAD, NONE, (WEAPON_SINGLE_TARGET)
        .lobytes  0, -1, SPRITE_TILE_FLAIL_HEAD, SFX_HZ, (WEAPON_SINGLE_TARGET | WEAPON_CANCEL_MOVEMENT)

flail_east:
        ;         X,  Y, TileId, Behavior
        .lobytes  1, -2, SPRITE_TILE_FLAIL_HEAD, NONE, (WEAPON_SINGLE_TARGET)
        .lobytes  1,  2, SPRITE_TILE_FLAIL_HEAD, NONE, (WEAPON_SINGLE_TARGET)
        .lobytes  1, -1, SPRITE_TILE_FLAIL_HEAD, NONE, (WEAPON_SINGLE_TARGET)
        .lobytes  1,  1, SPRITE_TILE_FLAIL_HEAD, NONE, (WEAPON_SINGLE_TARGET)
