...
spear_north:
        ...
        .lobytes  0, -2, SPRITE_TILE_SPEAR_NORTH_1, SPRITE_TILE_SPEAR_NORTH_2, (WEAPON_CANCEL_MOVEMENT | WEAPON_SINGLE_TARGET)

spear_east:
        ;         X,  Y, TileId, Behavior
        .lobytes  1,  0, SPRITE_TILE_SPEAR_EAST_1, SPRITE_TILE_SPEAR_EAST_2, (WEAPON_CANCEL_MOVEMENT | WEAPON_SINGLE_TARGET)
        .lobytes  2,  0, SPRITE_TILE_SPEAR_EAST_1, SPRITE_TILE_SPEAR_EAST_2, (WEAPON_CANCEL_MOVEMENT | WEAPON_SINGLE_TARGET)

spear_south:
        ;         X,  Y, TileId, Behavior
        .lobytes  0,  1, SPRITE_TILE_SPEAR_SOUTH_1, SPRITE_TILE_SPEAR_SOUTH_2, (WEAPON_CANCEL_MOVEMENT | WEAPON_SINGLE_TARGET)
        .lobytes  0,  2, SPRITE_TILE_SPEAR_SOUTH_1, SPRITE_TILE_SPEAR_SOUTH_2, (WEAPON_CANCEL_MOVEMENT | WEAPON_SINGLE_TARGET)

spear_west:
        ;         X,  Y, TileId, Behavior
        .lobytes -1,  0, SPRITE_TILE_SPEAR_WEST_1, SPRITE_TILE_SPEAR_WEST_2, (WEAPON_CANCEL_MOVEMENT | WEAPON_SINGLE_TARGET)
        .lobytes -2,  0, SPRITE_TILE_SPEAR_WEST_1, SPRITE_TILE_SPEAR_WEST_2, (WEAPON_CANCEL_MOVEMENT | WEAPON_SINGLE_TARGET)
...
flail_north:
        ;         X,  Y, TileId, Behavior
        .lobytes -2, -1, SPRITE_TILE_FLAIL_WEST, SFX_HZ, (WEAPON_SINGLE_TARGET)
        .lobytes  2, -1, SPRITE_TILE_FLAIL_EAST, SFX_HZ, (WEAPON_SINGLE_TARGET)
        .lobytes -1, -1, SPRITE_TILE_FLAIL_WEST, SFX_HZ, (WEAPON_SINGLE_TARGET)
        .lobytes  1, -1, SPRITE_TILE_FLAIL_EAST, SFX_HZ, (WEAPON_SINGLE_TARGET)
        .lobytes  0, -1, SPRITE_TILE_FLAIL_NORTH, SFX_HZ, (WEAPON_SINGLE_TARGET | WEAPON_CANCEL_MOVEMENT)

flail_east:
        ;         X,  Y, TileId, Behavior
        .lobytes  1, -2, SPRITE_TILE_FLAIL_NORTH, SFX_VT, (WEAPON_SINGLE_TARGET)
        .lobytes  1,  2, SPRITE_TILE_FLAIL_SOUTH, SFX_VT, (WEAPON_SINGLE_TARGET)
        .lobytes  1, -1, SPRITE_TILE_FLAIL_NORTH, SFX_VT, (WEAPON_SINGLE_TARGET)
        .lobytes  1,  1, SPRITE_TILE_FLAIL_SOUTH, SFX_VT, (WEAPON_SINGLE_TARGET)
        .lobytes  1,  0, SPRITE_TILE_FLAIL_EAST, SFX_VT, (WEAPON_SINGLE_TARGET | WEAPON_CANCEL_MOVEMENT)
...
flail_south:
        ...
        .lobytes -1,  1, SPRITE_TILE_FLAIL_WEST, SFX_HZ, (WEAPON_SINGLE_TARGET)
        .lobytes  1,  1, SPRITE_TILE_FLAIL_EAST, SFX_HZ, (WEAPON_SINGLE_TARGET)
        .lobytes  0,  1, SPRITE_TILE_FLAIL_SOUTH, SFX_HZ, (WEAPON_SINGLE_TARGET | WEAPON_CANCEL_MOVEMENT)
...
flail_west:
        ...
        .lobytes -1, -1, SPRITE_TILE_FLAIL_NORTH, SFX_VT, (WEAPON_SINGLE_TARGET)
        .lobytes -1,  1, SPRITE_TILE_FLAIL_SOUTH, SFX_VT, (WEAPON_SINGLE_TARGET)
        .lobytes -1,  0, SPRITE_TILE_FLAIL_WEST, SFX_VT, (WEAPON_SINGLE_TARGET | WEAPON_CANCEL_MOVEMENT)