...
mole_spell_lut:
        .word ENEMY_BOMB_SPELL_mole_elemental_attack ; SPELL_FIRE
        .word ENEMY_BOMB_SPELL_mole_elemental_attack ; SPELL_AIR
        .word ENEMY_BOMB_SPELL_mole_elemental_attack ; SPELL_ICE
        .word ENEMY_BOMB_SPELL_mole_elemental_attack ; SPELL_EARTH
        .word FIXED_no_behavior                ; SPELL_BOMB
        .word FIXED_no_behavior                ; SPELL_LIFE

.proc ENEMY_BOMB_SPELL_mole_spell_dispatch
DispatchPtr := R0
;Length := R13
CurrentRow := R14
CurrentTile := R15
...
safe_to_dispatch:
        asl
        tax
        lda mole_spell_lut+0, x
        sta DispatchPtr+0
        lda mole_spell_lut+1, x
        sta DispatchPtr+1
        jmp (DispatchPtr)
        ; does not return
.endproc

.proc ENEMY_BOMB_SPELL_mole_elemental_attack
EnemyHealth := R12
