...
zone_4c_floor_1:
        ...
        .addr zone_4c_blocking_mazes ; Maze Pool
        .addr zone_4c_floor_1_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 0   ; Added Tempo
        .word zone_4c_banner_1 ; HudBanner
        .addr hud_hub_pal
...
zone_4c_floor_2:
        ...
        .addr zone_4c_blocking_with_warps_mazes ; Maze Pool
        .addr zone_4c_floor_2_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 5   ; Added Tempo
        .word zone_4c_banner_2 ; HudBanner
        .addr hud_hub_pal
...
zone_4c_floor_3:
        ...
        .addr zone_4c_blocking_with_warps_mazes ; Maze Pool
        .addr zone_4c_floor_3_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 10   ; Added Tempo
        .word zone_4c_banner_3 ; HudBanner
        .addr hud_hub_pal
        .addr rare_treasure_table       ; ShopLootPtr0
        .addr rare_treasure_table       ; ShopLootPtr1
        .addr common_treasure_table     ; ShopLootPtr2
...
zone_4c_floor_4:
        ...
        .addr zone_4c_blocking_with_warps_mazes ; Maze Pool
        .addr zone_4c_floor_4_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 15   ; Added Tempo
        .word zone_4c_banner_4 ; HudBanner
        .addr hud_hub_pal
        .addr rare_treasure_table       ; ShopLootPtr0
        .addr rare_treasure_table       ; ShopLootPtr1
        .addr common_treasure_table     ; ShopLootPtr2
...
zone_4c_floor_boss:
        ...
        .addr zone_4c_floor_boss_mazes ; Maze Pool
        .addr zone_4c_floor_boss_exits ; Exit List
        .byte TRACK_SILENCE      ; Music Track
        .byte 0                  ; Added Tempo
        .word zone_4c_banner_boss ; HudBanner
        .addr hud_hub_pal
...
zone_4c_blocking_with_warps_mazes:
        .byte 4 ; length        
...
zone_4c_floor_boss_exits:
        .byte 1 ; length
        banked_addr zone_5s_floor_1

zone_4c_floor_boss_mazes:
        .byte 1 ; Length
        banked_addr floor_zone_4c_boss
