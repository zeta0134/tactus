...
zone_2c_name_str: .byte "Placeholder 2C", D_CLOSE
zone_sequence_str_2c_1: .byte "2-1", D_CLOSE
zone_sequence_str_2c_2: .byte "2-2", D_CLOSE
zone_sequence_str_2c_3: .byte "2-3", D_CLOSE
zone_sequence_str_2c_4: .byte "2-4", D_CLOSE
zone_sequence_str_2c_B: .byte "2-B", D_CLOSE
...
zone_2c_floor_1:
        ...
        .addr zone_2c_blocking_mazes ; Maze Pool
        .addr zone_2c_floor_1_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 0   ; Added Tempo
        .word zone_2c_banner_1 ; HudBanner
        .addr hud_hub_pal
        ...
        .word zone_2c_name_str            ; NameStr
        .word zone_sequence_str_2c_1       ; SequenceStr
...
zone_2c_floor_2:
        ...
        .addr zone_2c_blocking_with_warps_mazes ; Maze Pool
        .addr zone_2c_floor_2_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 5   ; Added Tempo
        .word zone_2c_banner_2 ; HudBanner
        .addr hud_hub_pal
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_2c_name_str            ; NameStr
        .word zone_sequence_str_2c_2       ; SequenceStr
...
zone_2c_floor_3:
        ...
        .addr zone_2c_blocking_with_warps_mazes ; Maze Pool
        .addr zone_2c_floor_3_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 10   ; Added Tempo
        .word zone_2c_banner_3 ; HudBanner
        .addr hud_hub_pal
        .addr rare_treasure_table       ; ShopLootPtr0
        .addr rare_treasure_table       ; ShopLootPtr1
        .addr common_treasure_table     ; ShopLootPtr2
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_2c_name_str            ; NameStr
        .word zone_sequence_str_2c_3       ; SequenceStr
...
zone_2c_floor_4:
        ...
        .addr zone_2c_blocking_with_warps_mazes ; Maze Pool
        .addr zone_2c_floor_4_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 15   ; Added Tempo
        .word zone_2c_banner_4 ; HudBanner
        .addr hud_hub_pal
        .addr rare_treasure_table       ; ShopLootPtr0
        .addr rare_treasure_table       ; ShopLootPtr1
        .addr common_treasure_table     ; ShopLootPtr2
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_2c_name_str            ; NameStr
        .word zone_sequence_str_2c_4       ; SequenceStr
...
zone_2c_floor_boss:
        ...
        .addr zone_2c_floor_boss_mazes ; Maze Pool
        .addr zone_2c_floor_boss_exits ; Exit List
        .byte TRACK_SILENCE      ; Music Track
        .byte 0                  ; Added Tempo
        .word zone_2c_banner_boss ; HudBanner
        .addr hud_hub_pal
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_2c_name_str            ; NameStr
        .word zone_sequence_str_2c_B       ; SequenceStr
...
zone_2c_blocking_with_warps_mazes:
        .byte 4 ; length        
...
zone_2c_floor_boss_exits:
        .byte 3 ; length
        banked_addr zone_3a_floor_1
        banked_addr zone_3b_floor_1
        banked_addr zone_3c_floor_1

zone_2c_floor_boss_mazes:
        .byte 1 ; Length
        banked_addr floor_zone_2c_boss
