...
zone_5w_name_str: .byte "Placeholder 5W", D_CLOSE
zone_sequence_str_5w_1: .byte "5-1", D_CLOSE
zone_sequence_str_5w_F: .byte "5-B", D_CLOSE
...
zone_5w_floor_1:
        ...
        .word zone_sequence_str_5w_1       ; SequenceStr
...
zone_5w_floor_boss:
        ...
        .addr blocking_warp_structure_set ; ExteriorStructureWarpSet
        .word zone_5w_name_str            ; NameStr
        .word zone_sequence_str_5w_F       ; SequenceStr
