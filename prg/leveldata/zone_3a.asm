...
zone_3a_name_str: .byte "Placeholder 3A", D_CLOSE
zone_sequence_str_3a_1: .byte "3-1", D_CLOSE
zone_sequence_str_3a_2: .byte "3-2", D_CLOSE
zone_sequence_str_3a_3: .byte "3-3", D_CLOSE
zone_sequence_str_3a_4: .byte "3-4", D_CLOSE
zone_sequence_str_3a_B: .byte "3-B", D_CLOSE
...
zone_3a_floor_1:
        ...
        .addr zone_3a_blocking_mazes ; Maze Pool
        .addr zone_3a_floor_1_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 0   ; Added Tempo
        .word zone_3a_banner_1 ; HudBanner
        .addr hud_hub_pal
        ...
        .word zone_3a_name_str            ; NameStr
        .word zone_sequence_str_3a_1       ; SequenceStr
        rng_index_for_zone 3, 1           ; RngIndex
...
zone_3a_floor_1_exits:
        .byte 5 ; length
        banked_addr zone_3a_floor_2
        banked_addr zone_4a_floor_1 ; warp destinations
...
zone_3a_floor_2:
        ...
        .addr zone_3a_blocking_with_warps_mazes ; Maze Pool
        .addr zone_3a_floor_2_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 5   ; Added Tempo
        .word zone_3a_banner_2 ; HudBanner
        .addr hud_hub_pal
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_3a_name_str            ; NameStr
        .word zone_sequence_str_3a_2       ; SequenceStr
        rng_index_for_zone 3, 2           ; RngIndex
        .byte ZONE_ONLOAD_NONE            ; OnLoadBehavior
        .word standard_chest_structure_set_interior   ; StandardChestInteriorStructures
        .word standard_chest_structure_set_exterior   ; StandardChestExteriorStructures
        .word standard_chest_treasure_table  ; StandardChestLootTable
...
zone_3a_floor_3:
        ...
        .addr zone_3a_blocking_with_warps_mazes ; Maze Pool
        .addr zone_3a_floor_3_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 10   ; Added Tempo
        .word zone_3a_banner_3 ; HudBanner
        .addr hud_hub_pal
        .addr rare_treasure_table       ; ShopLootPtr0
        .addr rare_treasure_table       ; ShopLootPtr1
        .addr common_treasure_table     ; ShopLootPtr2
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_3a_name_str            ; NameStr
        .word zone_sequence_str_3a_3       ; SequenceStr
        rng_index_for_zone 3, 3           ; RngIndex
        .byte ZONE_ONLOAD_NONE            ; OnLoadBehavior
        .word standard_chest_structure_set_interior   ; StandardChestInteriorStructures
        .word standard_chest_structure_set_exterior   ; StandardChestExteriorStructures
        .word standard_chest_treasure_table  ; StandardChestLootTable
...
zone_3a_floor_4:
        ...
        .addr zone_3a_blocking_with_warps_mazes ; Maze Pool
        .addr zone_3a_floor_4_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 15   ; Added Tempo
        .word zone_3a_banner_4 ; HudBanner
        .addr hud_hub_pal
        .addr rare_treasure_table       ; ShopLootPtr0
        .addr rare_treasure_table       ; ShopLootPtr1
        .addr common_treasure_table     ; ShopLootPtr2
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_3a_name_str            ; NameStr
        .word zone_sequence_str_3a_4       ; SequenceStr
        rng_index_for_zone 3, 4           ; RngIndex
        .byte ZONE_ONLOAD_NONE            ; OnLoadBehavior
        .word standard_chest_structure_set_interior   ; StandardChestInteriorStructures
        .word standard_chest_structure_set_exterior   ; StandardChestExteriorStructures
        .word standard_chest_treasure_table  ; StandardChestLootTable
...
zone_3a_floor_boss:
        ...
        .addr zone_3a_floor_boss_mazes ; Maze Pool
        .addr zone_3a_floor_boss_exits ; Exit List
        .byte TRACK_SILENCE      ; Music Track
        .byte 0                  ; Added Tempo
        .word zone_3a_banner_boss ; HudBanner
        .addr hud_hub_pal
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_3a_name_str            ; NameStr
        .word zone_sequence_str_3a_B       ; SequenceStr
        rng_index_for_zone 3, 5           ; RngIndex
        .byte ZONE_ONLOAD_NONE            ; OnLoadBehavior
...
zone_3a_blocking_with_warps_mazes:
        .byte 4 ; length        
...
zone_3a_floor_boss_exits:
        .byte 3 ; length
        banked_addr zone_4a_floor_1
        banked_addr zone_4b_floor_1
        banked_addr zone_4c_floor_1

zone_3a_floor_boss_mazes:
        .byte 1 ; Length
        banked_addr floor_zone_3a_boss