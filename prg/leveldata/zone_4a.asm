...
zone_4a_name_str: .byte "Placeholder 4A", D_CLOSE
zone_sequence_str_4a_1: .byte "4-1", D_CLOSE
zone_sequence_str_4a_2: .byte "4-2", D_CLOSE
zone_sequence_str_4a_3: .byte "4-3", D_CLOSE
zone_sequence_str_4a_4: .byte "4-4", D_CLOSE
zone_sequence_str_4a_B: .byte "4-B", D_CLOSE
...
zone_4a_floor_1:
        ...
        .addr zone_4a_blocking_mazes ; Maze Pool
        .addr zone_4a_floor_1_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 0   ; Added Tempo
        .word zone_4a_banner_1 ; HudBanner
        .addr hud_hub_pal
        ...
        .word zone_4a_name_str            ; NameStr
        .word zone_sequence_str_4a_1       ; SequenceStr
...
zone_4a_floor_2:
        ...
        .addr zone_4a_blocking_with_warps_mazes ; Maze Pool
        .addr zone_4a_floor_2_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 5   ; Added Tempo
        .word zone_4a_banner_2 ; HudBanner
        .addr hud_hub_pal
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_4a_name_str            ; NameStr
        .word zone_sequence_str_4a_2       ; SequenceStr
...
zone_4a_floor_3:
        ...
        .addr zone_4a_blocking_with_warps_mazes ; Maze Pool
        .addr zone_4a_floor_3_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 10   ; Added Tempo
        .word zone_4a_banner_3 ; HudBanner
        .addr hud_hub_pal
        .addr rare_treasure_table       ; ShopLootPtr0
        .addr rare_treasure_table       ; ShopLootPtr1
        .addr common_treasure_table     ; ShopLootPtr2
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_4a_name_str            ; NameStr
        .word zone_sequence_str_4a_3       ; SequenceStr
...
zone_4a_floor_4:
        ...
        .addr zone_4a_blocking_with_warps_mazes ; Maze Pool
        .addr zone_4a_floor_4_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 15   ; Added Tempo
        .word zone_4a_banner_4 ; HudBanner
        .addr hud_hub_pal
        .addr rare_treasure_table       ; ShopLootPtr0
        .addr rare_treasure_table       ; ShopLootPtr1
        .addr common_treasure_table     ; ShopLootPtr2
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_4a_name_str            ; NameStr
        .word zone_sequence_str_4a_4       ; SequenceStr
...
zone_4a_floor_boss:
        ...
        .addr zone_4a_floor_boss_mazes ; Maze Pool
        .addr zone_4a_floor_boss_exits ; Exit List
        .byte TRACK_SILENCE      ; Music Track
        .byte 0                  ; Added Tempo
        .word zone_4a_banner_boss ; HudBanner
        .addr hud_hub_pal
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_4a_name_str            ; NameStr
        .word zone_sequence_str_4a_B       ; SequenceStr
...
zone_4a_blocking_with_warps_mazes:
        .byte 4 ; length        
...
zone_4a_floor_boss_mazes:
        .byte 1 ; Length
        banked_addr floor_zone_4a_boss
