...
zone_3b_name_str: .byte "Placeholder 3B", D_CLOSE
zone_sequence_str_3b_1: .byte "3-1", D_CLOSE
zone_sequence_str_3b_2: .byte "3-2", D_CLOSE
zone_sequence_str_3b_3: .byte "3-3", D_CLOSE
zone_sequence_str_3b_4: .byte "3-4", D_CLOSE
zone_sequence_str_3b_B: .byte "3-B", D_CLOSE
...
zone_3b_floor_1:
        ...
        .addr zone_3b_blocking_mazes ; Maze Pool
        .addr zone_3b_floor_1_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 0   ; Added Tempo
        .word zone_3b_banner_1 ; HudBanner
        .addr hud_hub_pal
        ...
        .word zone_3b_name_str            ; NameStr
        .word zone_sequence_str_3b_1       ; SequenceStr
...
zone_3b_floor_2:
        ...
        .addr zone_3b_blocking_with_warps_mazes ; Maze Pool
        .addr zone_3b_floor_2_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 5   ; Added Tempo
        .word zone_3b_banner_2 ; HudBanner
        .addr hud_hub_pal
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_3b_name_str            ; NameStr
        .word zone_sequence_str_3b_2       ; SequenceStr
...
zone_3b_floor_3:
        ...
        .addr zone_3b_blocking_with_warps_mazes ; Maze Pool
        .addr zone_3b_floor_3_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 10   ; Added Tempo
        .word zone_3b_banner_3 ; HudBanner
        .addr hud_hub_pal
        .addr rare_treasure_table       ; ShopLootPtr0
        .addr rare_treasure_table       ; ShopLootPtr1
        .addr common_treasure_table     ; ShopLootPtr2
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_3b_name_str            ; NameStr
        .word zone_sequence_str_3b_3       ; SequenceStr
...
zone_3b_floor_4:
        ...
        .addr zone_3b_blocking_with_warps_mazes ; Maze Pool
        .addr zone_3b_floor_4_exits ; Exit List
        .byte TRACK_SHOWER_GROOVE   ; Music Track
        .byte 15   ; Added Tempo
        .word zone_3b_banner_4 ; HudBanner
        .addr hud_hub_pal
        .addr rare_treasure_table       ; ShopLootPtr0
        .addr rare_treasure_table       ; ShopLootPtr1
        .addr common_treasure_table     ; ShopLootPtr2
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_3b_name_str            ; NameStr
        .word zone_sequence_str_3b_4       ; SequenceStr
...
zone_3b_floor_boss:
        ...
        .addr zone_3b_floor_boss_mazes ; Maze Pool
        .addr zone_3b_floor_boss_exits ; Exit List
        .byte TRACK_SILENCE      ; Music Track
        .byte 0                  ; Added Tempo
        .word zone_3b_banner_boss ; HudBanner
        .addr hud_hub_pal
        ...
        .addr blocking_warp_structure_set ;ExteriorStructureWarpSet
        .word zone_3b_name_str            ; NameStr
        .word zone_sequence_str_3b_B       ; SequenceStr
...
zone_3b_blocking_with_warps_mazes:
        .byte 4 ; length        
...
zone_3b_floor_boss_exits:
        .byte 3 ; length
        banked_addr zone_4a_floor_1
        banked_addr zone_4b_floor_1
        banked_addr zone_4c_floor_1

zone_3b_floor_boss_mazes:
        .byte 1 ; Length
        banked_addr floor_zone_3b_boss
